...
import { SoftwareData } from "@/lib/digitalize"
import { cn } from "@/lib/utils"

export const columns = (data: SoftwareData): ColumnDef<SoftwareData["data"][number]>[] => ([
  {
  ...
  ...data.baselines.map((baseline, index) => ({
    ...
    cell: ({ row }: { row: Row<SoftwareData["data"][number]>}) => {
...
export function SoftwareTable({data}: {data: SoftwareData}) {
