...
export const description = "Set a user as admin of the server" as const;

export const options = [
  {
    name: "admin",
    description: "The users to set as admin",
...
export const execute = async (helper: DiscordInteractionHelper) => {
  ...
  const result = await GuildCache.get().addAdmin(user.id);
